...
namespace Organizr.Domain.UnitTests.Planning.TodoListAggregate
{
    public class TodoListTests
    {
        ...
        public void TodoListConstructor_ValidData_ObjectInitializedProperly()
        {
            ...
            var sut = new TodoList(id, creatorUserId, title, description);
        ...
        [Fact]
        public void TodoListConstructor_DefaultId_ThrowsArgumentException()
        {
            var defaultId = Guid.Empty;

            Func<TodoList> sut = () => new TodoList(defaultId, "User1", "TodoListTitle", "TodoListDescription");
        ...
        {
            Func<TodoList> sut = () => new TodoList(Guid.NewGuid(), "User1", title);
        ...
        {
            var sut = new TodoList(Guid.NewGuid(), "User1", "Todo List 1 Title", "Todo List 1 Description");
