...
{
    public class EditTodoSubListCommandTests : TodoListCommandTestsBase
    {
        private readonly EditTodoSubListCommandHandler _sut;

        public EditTodoSubListCommandTests()
        {
            _sut = new EditTodoSubListCommandHandler(IdentityServiceMock.Object, TodoListRepositoryMock.Object);
        }
