...
using Organizr.Application.Planning.TodoLists.Commands.MoveTodoSubList;
...
{
    public class MoveTodoSubListCommandTests : TodoListCommandTestsBase
    {
        private readonly MoveTodoSubListCommandHandler _sut;

        public MoveTodoSubListCommandTests()
        {
            _sut = new MoveTodoSubListCommandHandler(IdentityServiceMock.Object, TodoListRepositoryMock.Object);
        }
